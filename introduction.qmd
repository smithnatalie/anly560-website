...
In this project, I will be using time series analysis to study the the current consequences of climate change and predict its potential impacts on the future by zooming in on the state of Florida and answering the following questions:
  ...
  5. Have the number hurricanes and tropical storms affecting the state changed over the last few decades?
  6. Has the intensity and damage caused by major storms (particularly hurricanes and tropical storms) affecting the state increased?
  7. Has flooding overall in coastal Floridian cities and town changed over the years?
  8. Has the cost of repairing damage done by major storms, storm surge, and flooding increased over the last few decades?
  9. How has climate change affected the cost of homes, home insurance, and/or flood insurance in coastal Floridian cities and towns?
  10. What is the extent to which Florida's coastline has receded over the decades?
    i.) Is the state experiencing coastal erosion at a faster rate than in previous decades?
